    ...
    public class Service : IService
    {
        ...
        public Resultado Buscar(string filtro, string pageId, bool? siguiente = null)
        {
            try
            {
                ...
                resultado.CantidadDePaginas = resultado.CantidadDePaginas > 9999 ? 9999 : resultado.CantidadDePaginas;
                resultado.CantidadDePaginas = resultado.CantidadDePaginas == 0 ? 1 : resultado.CantidadDePaginas;
